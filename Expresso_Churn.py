...
if st.button('Predict Churn'):
    ...
    label_encoder_tenure.fit_transform(input_data['TENURE'])

    label_encoder_top_pack = LabelEncoder()
    label_encoder_top_pack.fit_transform(input_data['TOP_PACK'])

    label_encoder_region = LabelEncoder()
    label_encoder_region.fit_transform(input_data['REGION'])

    label_encoder_mrg = LabelEncoder()
    label_encoder_mrg.fit_transform(input_data['MRG'])
